        ...
        function selectCategory(category) {
         ...
         <div class="row">
           ...
           <div class="col-4">
             ...
             <p>140</p>
             <button class="addToCart" onclick="addToCart('Cheezy Fire Wall', 140, '1.png', 'plus')">Add to Cart</button>
           </div>
             ...
             <div class="col-4">
                ...
                <p>130</p>
                <button class="addToCart" onclick="addToCart('Happy Skatertask', 130, '11.png', 'plus')">Add to Cart</button>
